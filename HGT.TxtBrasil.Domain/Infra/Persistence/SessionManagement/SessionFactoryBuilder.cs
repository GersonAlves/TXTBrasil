...
using NHibernate;
using Workker.Telemetria.InfraStructure.Persistence.SessionConfiguration;
using Workker.Telemetria.InfraStructure.ScopeInstance;

namespace Workker.Telemetria.InfraStructure.Persistence.SessionManagement
{
