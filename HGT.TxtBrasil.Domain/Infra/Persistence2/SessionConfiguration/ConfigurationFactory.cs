...
using Workker.Telemetria.Domain;
using Workker.Telemetria.Domain.Entities.Telemetria;
...
namespace Workker.Telemetria.InfraStructure.Persistence.SessionConfiguration
{
    ...
    /// </summary>
    public class ConfigurationFactory : Workker.Telemetria.InfraStructure.Persistence.SessionConfiguration.IConfigurationFactory
    {
        /// <summary>
        ...
        public FluentConfiguration Build()
        {
            return Fluently.Configure().Database(MsSqlConfiguration.MsSql2008.ConnectionString(c => c
                                                                                                        .FromAppSetting(
                                                                                                            "Conexao")))
                           .Mappings(m => m.FluentMappings.AddFromAssemblyOf<ProtocoloMardan>())
